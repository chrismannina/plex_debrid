...
crt_cod = [
    ...
    {"name": "C\xc3\xb4te d'Ivoire", "code": "ci"},
...
lan_ctr = [
    ...
    [
        "pt",
        ["ao", "br", "cv", "gq", "fr", "gw", "lu", "mo", "mz", "pt", "st", "ch", "tl"],
    ],
    [
        "es",
        [
    ...
    ["hy", ["am"]],
    ["nl", ["aw", "be", "bq", "cw", "nl", "sx", "sr"]],
    ["de", ["de"]],
    ["az", ["az"]],
    ["bn", ["bd", "in"]],
    ["ccp", ["bd", "in"]],
    ["be", ["by"]],
    ["ru", ["by", "kz", "kg", "md", "ru", "ua"]],
    ["wa", ["be"]],
    ["yo", ["bj", "ng"]],
    ["dz", ["bt"]],
    ["qu", ["bo", "ec", "pe"]],
    ...
    ["ms", ["bn", "my", "sg"]],
    ["bg", ["bg"]],
    ["ff", ["bf", "cm", "gm", "gh", "gw", "gn", "lr", "mr", "ne", "ng", "sn", "sl"]],
    ["rn", ["bi"]],
    ["km", ["kh"]],
    ["agq", ["cm"]],
    ["ksf", ["cm"]],
